        ...
        <Tabs defaultValue="identity" className="flex-1 flex flex-col overflow-hidden">
          ...
          <TabsContent value="identity" className="flex-1 overflow-y-auto p-6 space-y-4 m-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl border border-hairline bg-card/60 space-y-2">
                <div className="text-xs font-semibold text-muted-foreground">
                  Author pseudonym
                </div>
                <div className="font-mono text-base font-bold text-verified">
          ...
          <TabsContent value="cli" className="flex-1 overflow-y-auto p-6 space-y-4 m-0">
            ...
            <div className="p-4 rounded-xl bg-surface-elevated border border-hairline space-y-3">
              <div className="flex items-center justify-between text-xs text-muted-foreground border-b border-hairline pb-2">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-6 px-2 text-xs font-mono text-muted-foreground hover:text-foreground hover:bg-overlay gap-1"
              ...
              <div className="font-mono text-xs text-verified overflow-x-auto select-all p-1">
                {curlCommand}
              </div>
            </div>
          </TabsContent>
